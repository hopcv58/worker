<header class="main-header">
    ...
    <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Talaha</b> admin area</span>
    </a>
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="{{asset('upload/img_profile/meo.jpg')}}" class="img-circle"
                                                 alt="User Image">
                                        </div>
                                        <h4>
                                            Support Team
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        @if (($img = Auth::user()->img) == null)
                            <img src="{{asset('upload/img_profile/meo.jpg')}}" class="user-image" alt="User Image">
                        @else
                            <img src="{{asset("upload/img_profile/$img")}}" class="user-image" alt="User Image">
                        @endif
