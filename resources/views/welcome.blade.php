...
@section('content')
    ...
    ================================================== -->
    <div class="example">
        <h2 class="example-title">Color Swatches <span>(<b>More Colors See</b>: <a href="color-picker.html">Flat UI Color Picker</a>)</span>
        </h2>
        <div class="row">
            <div class="col-md-2">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="btn-group">
                            <button type="button" class="btn btn-default"><i class="glyphicon glyphicon-align-left"></i>
                            </button>
                            <button type="button" class="btn btn-default"><i
                                        class="glyphicon glyphicon-align-center"></i></button>
                            <button type="button" class="btn btn-default"><i
                                        class="glyphicon glyphicon-align-right"></i></button>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="btn-group">
                            <button type="button" class="btn btn-primary"><i class="glyphicon glyphicon-align-left"></i>
                            </button>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="btn-group">
                            <button type="button" class="btn btn-success"><i class="glyphicon glyphicon-align-left"></i>
                            </button>
                    ...
                    <div class="col-md-4">
                        <div class="btn-group">
                            <button type="button" class="btn btn-info"><i class="glyphicon glyphicon-align-left"></i>
                            </button>
                            <button type="button" class="btn btn-info"><i class="glyphicon glyphicon-align-center"></i>
                            </button>
                            <button type="button" class="btn btn-info"><i class="glyphicon glyphicon-align-right"></i>
                            </button>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="btn-group">
                            <button type="button" class="btn btn-warning"><i class="glyphicon glyphicon-align-left"></i>
                            </button>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="btn-group">
                            <button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-align-left"></i>
                            </button>
                            <button type="button" class="btn btn-danger"><i
                                        class="glyphicon glyphicon-align-center"></i></button>
                            <button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-align-right"></i>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="btn-group-vertical">
                            ...
                            <button type="button" class="btn btn-default"><i class="glyphicon glyphicon-user"></i>
                            </button>
                            <button type="button" class="btn btn-default"><i class="glyphicon glyphicon-comment"></i>
                            </button>
                            <button type="button" class="btn btn-default"><i class="glyphicon glyphicon-cog"></i>
                            </button>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="btn-group-vertical">
                            <button type="button" class="btn btn-primary"><i class="glyphicon glyphicon-home"></i>
                            </button>
                            <button type="button" class="btn btn-primary"><i class="glyphicon glyphicon-user"></i>
                            </button>
                            <button type="button" class="btn btn-primary"><i class="glyphicon glyphicon-comment"></i>
                            </button>
                            <button type="button" class="btn btn-primary"><i class="glyphicon glyphicon-cog"></i>
                            </button>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="btn-group-vertical">
                            <button type="button" class="btn btn-success"><i class="glyphicon glyphicon-home"></i>
                            </button>
                            <button type="button" class="btn btn-success"><i class="glyphicon glyphicon-user"></i>
                            </button>
                            <button type="button" class="btn btn-success"><i class="glyphicon glyphicon-comment"></i>
                            </button>
                            <button type="button" class="btn btn-success"><i class="glyphicon glyphicon-cog"></i>
                            </button>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="btn-group-vertical">
                            ...
                            <button type="button" class="btn btn-info"><i class="glyphicon glyphicon-comment"></i>
                            </button>
                    ...
                    <div class="col-md-2">
                        <div class="btn-group-vertical">
                            <button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-home"></i>
                            </button>
                            <button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-user"></i>
                            </button>
                            <button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-comment"></i>
                            </button>
                            <button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-cog"></i>
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div class="example">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="btn-group">
                    <button type="button" class="btn dropdown-toggle" data-toggle="dropdown">Normal <span
                ...
                <div class="blank"></div>
                <div class="btn-group">
                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">Default <span
                                class="caret"></span></button>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                ...
                <div class="blank"></div>
                <div class="btn-group">
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">Primary <span
                                class="caret"></span></button>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                ...
                <div class="blank"></div>
                <div class="btn-group">
                    <button type="button" class="btn btn-success dropdown-toggle" data-toggle="dropdown">Success <span
                                class="caret"></span></button>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                ...
                <div class="blank"></div>
                <div class="btn-group">
                    <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">Info <span
                                class="caret"></span></button>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                ...
                <div class="blank"></div>
                <div class="btn-group">
                    <button type="button" class="btn btn-warning dropdown-toggle" data-toggle="dropdown">Warning <span
                                class="caret"></span></button>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                ...
                <div class="blank"></div>
                <div class="btn-group">
                    <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown">Danger <span
                                class="caret"></span></button>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
                ...
                <div class="row">
                    <div class="col-md-6 example-dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li role="presentation" class="disabled"><a role="menuitem" tabindex="-1" href="#">Another
                                    action</a></li>
    ...
    ================================================== -->
    <div class="example">
        <h2 class="example-title">Stepper <span>(<b>How to use</b>: <a href="https://github.com/benplum/Stepper"
                                                                       target="_blank">https://github.com/benplum/Stepper</a>)</span>
        </h2>
        <div class="row">
            <div class="col-md-6">
    ...
    ================================================== -->
    <div class="example">
        <h2 class="example-title">Selecter <span>(<b>How to use</b>:  <a href="https://github.com/benplum/Selecter"
                                                                         target="_blank">https://github.com/benplum/Selecter</a>)</span>
        </h2>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <select name="selecter_basic" class="selecter_2"
                        data-selecter-options='{"label":"Jump Sites","external":"true"}'>
    ...
    ================================================== -->
    <div class="example">
        <h2 class="example-title">Checkboxes and Radios <span>(<b>How to use</b>: <a
                        href="https://github.com/fronteed/iCheck/"
                        target="_blank">https://github.com/fronteed/iCheck/</a>)</span></h2>
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="timeline">
                    <dl>
                        ...
                        <dd class="pos-right clearfix">
                            ...
                            <div class="events">
                                <div class="pull-left">
                                    <img class="events-object img-rounded" src="{{asset('bootflat/img/photo-1.jpg')}}">
                                </div>
                        ...
                        <dd class="pos-left clearfix">
                            ...
                            <div class="events">
                                <div class="pull-left">
                                    <img class="events-object img-rounded" src="{{asset('bootflat/img/photo-2.jpg')}}">
                                </div>
                                <div class="events-body">
                        ...
                        <dd class="pos-right clearfix">
                            ...
                            <div class="events">
                                <div class="pull-left">
                                    <img class="events-object img-rounded" src="{{asset('bootflat/img/photo-3.jpg')}}">
                                </div>
                                <div class="events-body">
                        ...
                        <dd class="pos-left clearfix">
                            ...
                            <div class="events">
                                <div class="pull-left">
                                    <img class="events-object img-rounded" src="{{asset('bootflat/img/photo-4.jpg')}}">
                                </div>
                                <div class="events-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="alert alert-warning alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <h4>Warning!</h4>
                    <p>Change this and that and try again. <a class="alert-link">Duis mollis</a>, est non commodo
                        luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur
                        purus sit amet fermentum.</p>
                    <p><a class="btn btn-warning" href="#">Take this action</a> <a class="btn btn-link" href="#">Or do
                            this</a></p>
                </div>
                <div class="alert alert-info">
                    ...
                    <p>Change this and that and try again. <a class="alert-link">Duis mollis</a>, est non commodo
                        luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur
                        purus sit amet fermentum.</p>
                    <p><a class="btn btn-primary" href="#">Take this action</a> <a class="btn btn-link" href="#">Or do
                            this</a></p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="alert alert-success alert-dismissable">
                    ...
                    <p>Change this and that and try again. <a class="alert-link">Duis mollis</a>, est non commodo
                        luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur
                        purus sit amet fermentum.</p>
                    <p><a class="btn btn-success" href="#">Take this action</a> <a class="btn btn-link" href="#">Or do
                            this</a></p>
                </div>
                <div class="alert alert-danger alert-dismissable">
                    ...
                    <p>Change this and that and try again. <a class="alert-link">Duis mollis</a>, est non commodo
                        luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur
                        purus sit amet fermentum.</p>
                    <p><a class="btn btn-danger" href="#">Take this action</a> <a class="btn btn-link" href="#">Or do
                            this</a></p>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="panel">
                    <ul id="myTab1" class="nav nav-tabs nav-justified">
                        ...
                        <li class="dropdown">
                            <a href="#" id="myTabDrop1-1" class="dropdown-toggle" data-toggle="dropdown">Dropdown <b
                                        class="caret"></b></a>
                    ...
                    <div id="myTabContent" class="tab-content">
                        ...
                        <div class="tab-pane fade" id="dropdown1-1">
                            <p>Etsy mixtape wayfarers, ethical wes anderson tofu before they sold out mcsweeney's
                                ...
                                pitchfork tattooed craft beer, iphone...</p>
                        </div>
                        <div class="tab-pane fade" id="dropdown1-2">
                            <p>Trust fund seitan letterpress, keytar raw denim keffiyeh etsy art party before they sold
                                ...
                                portland seitan DIY, art party locavore wolf cliche ... </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="tabbable tabs-below">
                        <div id="myTabContent" class="tab-content">
                            ...
                            <div class="tab-pane fade" id="profile2">
                                <p>Food truck fixie locavore, accusamus mcsweeney's marfa nulla single-origin coffee
                                    ...
                                    anderson artisan four loko farm-to-table craft beer twee. </p>
                            </div>
                            ...
                            <div class="tab-pane fade" id="dropdown2-2">
                                <p>Trust fund seitan letterpress, keytar raw denim keffiyeh etsy art party before they
                                    ...
                                    pack portland seitan DIY, art party locavore wolf cliche ... </p>
                            </div>
                        </div>
                        <ul id="myTab2" class="nav nav-tabs nav-justified">
                            ...
                            <li class="dropdown dropup">
                                <a href="#" id="myTabDrop2-1" class="dropdown-toggle" data-toggle="dropdown">Dropdown <b
                                            class="caret"></b></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1">
                        ...
                        <nav class="navbar navbar-default" role="navigation">
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-3">
                                    <p class="navbar-text navbar-right"><a class="navbar-link" href="">Signed in as Mark
                                            Otto</a></p>
                                </div>
                            </div>
                        </nav>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <ul id="myTab2" class="nav nav-pills nav-stacked">
                            ...
                            <li class="dropdown"><a href="#">Messages <span
                                            class="badge badge-danger pull-right">20</span></a></li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="example">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="jumbotron">
                    <div class="jumbotron-photo"><img src="{{asset('bootflat/img/Jumbotron.jpg')}}"/></div>
                ...
                <div class="jumbotron">
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active"><img src="{{asset('bootflat/img/slider1.jpg')}}"></div>
                            <div class="item"><img src="{{asset('bootflat/img/slider2.jpg')}}"></div>
                            <div class="item"><img src="{{asset('bootflat/img/slider3.jpg')}}"></div>
                        </div>
    ...
    <div class="example">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-3">
                <div class="thumbnail">
                    <img class="img-rounded" src="{{asset('bootflat/img/thumbnail-1.jpg')}}">
                    <div class="caption text-center">
                        <h3>Thumbnail label</h3>
                        <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta
                            gravida at eget metus. Nullam id ...</p>
                        <p><a href="#" class="btn btn-warning" role="button">Button</a> <a href="#"
            ...
            <div class="col-sm-6 col-md-3">
                <div class="thumbnail">
                    <img class="img-rounded" src="{{asset('bootflat/img/thumbnail-2.jpg')}}">
                    <div class="caption text-center">
                        <h3>Thumbnail label</h3>
                        <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta
                            gravida at eget metus. Nullam id ...</p>
            ...
            <div class="col-sm-6 col-md-3">
                <div class="thumbnail">
                    <img class="img-rounded" src="{{asset('bootflat/img/thumbnail-3.jpg')}}">
                    <div class="caption text-center">
                        <h3>Thumbnail label</h3>
                        <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta
                            gravida at eget metus. Nullam id ...</p>
            ...
            <div class="col-sm-6 col-md-3">
                <div class="thumbnail">
                    <img class="img-rounded" src="{{asset('bootflat/img/thumbnail-4.jpg')}}">
                    <div class="caption text-center">
                        <h3>Thumbnail label</h3>
                        <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta
                            gravida at eget metus. Nullam id ...</p>
                ...
                <ul class="media-list">
                    <li class="media">
                        <a class="pull-left" href="#"><img class="media-object img-rounded"
                                                           src="{{asset('bootflat/img/photo-1.jpg')}}"></a>
                        <div class="media-body">
                            ...
                            <div class="media">
                                <a class="pull-left" href="#"><img class="media-object img-rounded"
                                                                   src="{{asset('bootflat/img/photo-2.jpg')}}"></a>
                                <div class="media-body">
                                    ...
                                    <div class="media">
                                        <a class="pull-left" href="#"><img class="media-object img-rounded"
                                                                           src="{{asset('bootflat/img/photo-3.jpg')}}"></a>
                                        <div class="media-body">
                                            <h4 class="media-heading">Nested media heading</h4>
                    ...
                    <li class="media">
                        <a class="pull-right" href="#"><img class="media-object img-rounded"
                                                            src="{{asset('bootflat/img/photo-4.jpg')}}"></a>
                        <div class="media-body">
                            <h4 class="media-heading">Media heading</h4>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="example-typography">
                    ...
                    <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. <strong>Donec
                            ullamcorper</strong> nulla non metus auctor fringilla. Duis mollis, est non commodo luctus,
                        nisi erat porttitor ligula, eget lacinia odio sem nec elit.</p>
                </div>
                <div class="example-typography">
                    <span class="text-note">Image</span>
                    <img src="{{asset('bootflat/img/slider1.jpg')}}" alt="exaple-image"
                         class="img-rounded img-responsive">
                    <p class="img-comment"><strong>Note:</strong> gravida at eget metus. Duis mollis, est non commodo
                        luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.</p>
                </div>
                <div class="example-typography">
                    <span class="text-note">Lead Text</span>
                    <p class="lead">Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus
                        mus.</p>
                </div>
                <div class="example-typography">
                ...
                <div class="example-typography">
                    ...
                    <p>
                        <small>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.
